  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <h1 className="text-2xl font-bold tracking-tight">Neural Settings</h1>
        <p className="text-xs text-muted-foreground mt-1">Adaptive system configuration</p>
      </motion.div>

      {/* Radar Chart - CSS visualization */}
      <GlassCard className="p-6">
        <div className="flex items-center gap-2 mb-4">
          <TrendingUp size={16} className="text-ruby" />
          <h2 className="text-sm font-semibold">System Intelligence</h2>
        </div>
          ...
          {radarData.map((d, i) => (
            ...
            >
              <div className="relative w-full h-24 flex items-end justify-center">
                <motion.div
                  className="w-6 rounded-t-md bg-gradient-to-t from-ruby to-ruby-glow"
                  initial={{ height: 0 }}
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={`w-12 h-7 rounded-full transition-colors duration-300 flex items-center px-1 flex-shrink-0 ${
